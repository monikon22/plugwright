 ...
 *  confusing runtime error — see modes-and-plugins §6.2. */
...
export interface PluginTestRef {
     ...
     *  in reports. See modes-and-plugins §6.5. */
 ...
 * authentication hooks, inherited tests, cleanup. See modes-and-plugins §6.5.
 */
export interface PlugwrightPlugin<O = unknown> {
     ...
     *  the first. A one-shot "first test" can't cover a second bot or a rejoin; see
     *  modes-and-plugins §6.5 for why this is a hook rather than a `preflight` test. */
